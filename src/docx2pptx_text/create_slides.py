...
from docx2pptx_text.chunking import is_standard_heading
from docx2pptx_text.annotations.apply_to_slides import (
    annotate_slide,
...
def slides_from_chunks(
    ...
    for chunk in chunks:
        ...
        if config.DISPLAY_DOCX_ANNOTATIONS_IN_SLIDE_SPEAKER_NOTES:
